...
/**
 * Business Partner Update Response Structure V2
 * 
 * <p>Clase Java para DT_BusinessPartnerUpdateResp_sync complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DT_BusinessPartnerUpdateResp_sync"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DT_BusinessPartnerUpdateResp_sync", propOrder = {
    "messageHeader",
    "messageContentHeader",
    "log"
})
public class DTBusinessPartnerUpdateRespSync {
