...
@Component
@StepScope
public class ReadRowsInsuranceTaskletStep implements Tasklet, StepExecutionListener {
	private static final Logger log = LoggerFactory.getLogger(ReadRowsInsuranceTaskletStep.class);
